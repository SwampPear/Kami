...
INCLUDE = include
INCLUDE_PATH = src
SUB_DIR = src src/kami/core src/kami/graphics src/kami/utils src/kami/input src/kami/scene src/kami/graphics/Camera src/kami/graphics/renderer  src/kami/assetManager
LIB = lib/*
